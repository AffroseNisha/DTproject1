...
<tr>
<td rowspan="6"><img src="<c:url value="/resources/images/${prodinfo.proid}.jpg"/>"/></td>
</tr>
<tr>
<td>Product ID</td><td>${prodinfo.proid}</td>
</tr>
<tr>
<td>Product Name</td><td>${prodinfo.proname}</td>
</tr>
<tr>
...
<td> </td>
<td>
<form action="<c:url value="/addToCart/${prodinfo.proid}"/>" method="get">
